...
//! 2. `$FAILURE_HOME/managed_config.toml`
//! 3. `$FAILURE_HOME/config.toml`
//! 4. `$FAILURE_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/grok/requirements.toml`
//! 6. macOS MDM managed preferences (`fail.failure.build`, admin-forced) — macOS only
//!
