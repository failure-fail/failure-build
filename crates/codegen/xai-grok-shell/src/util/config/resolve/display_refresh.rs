...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "FAILURE_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "FAILURE_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`FAILURE_MIN_DRAW_MS` / `FAILURE_SCROLL_CADENCE_MS`).
