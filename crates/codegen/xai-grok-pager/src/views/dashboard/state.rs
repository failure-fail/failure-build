...
/// `~/.failure/config.toml`. Lenient — corrupted fields fall back to
...
/// Load the full persisted dashboard from `~/.failure/config.toml`.
///
...
/// `~/.failure/config.toml` (`[ui]`, `[hints]`, `[mcpServers]`, …).
///
