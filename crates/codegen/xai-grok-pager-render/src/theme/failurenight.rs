//! FailureNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// FailureNight palette — neutral gray base + TokyoNight accent colors.
//
