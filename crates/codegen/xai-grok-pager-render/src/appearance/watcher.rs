...
//!
//! In dev mode, watches ~/.failure/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.failure/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.failure/pager.toml, watches for changes
