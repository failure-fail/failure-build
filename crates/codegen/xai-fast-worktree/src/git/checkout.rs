...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + FAILURE_HOME → private tmp + restore).
        ...
        // global FAILURE_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since FAILURE_HOME is process-global.
